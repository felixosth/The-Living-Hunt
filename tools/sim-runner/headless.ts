...
export function runHeadless({
  ...
  const eventCounts: RunResult['eventCounts'] = { hourStarted: 0, dayStarted: 0, seasonStarted: 0 };
  ...
  return { state, startTime, steps, wallMs, eventCounts, daily, hash: stateHash(state) };
}
