...
- **The wind is drawn on the map** (second playtest): faint streaks blow with it, more and longer the harder it blows. A drifting haze of your scent was tried and dropped as too much. **Arrows fly** visibly from the bow and lie where they land; a hit throws up a puff of hair, and an arrow that hit flies to the animal where it's drawn.
- **Deer take their time at the water** (fourth playtest): 12–25 minutes drinking, then 10–25 grazing nearby, and a herd leader waits until every member has had its drink.
...
- **Aim sway and practice** (third playtest): the crosshair drifts slowly while drawn, and trembles when you are out of breath or your arms tire. The arrow goes where the crosshair is when you click, plus a small scatter you can't time away. Every arrow you loose is practice for your bow arm (a new *Hands* page in the journal); at most, practice makes the drift, tremor and scatter a fifth smaller and the drift slower. It never adds damage.
- **Animals get going:** a startled animal accelerates into its run (a roe deer is at full speed in about 0.7 s) and turns at a limited rate, so one facing you has to spin round first.
- **Jumping the string:** a suspicious or alarmed animal can react to the twang and drop and lurch before the arrow arrives, so the arrow strikes high and back: over the back, the spine, or the liver and gut. Close up (under about 8–13 m) the arrow gets there first, and an unaware animal never reacts. The inset warns when a watching animal is far enough away to do it.
- **Range and penetration:** an arrow goes about a quarter less deep at 50 m than point-blank, and the shoulder stops more arrows at range. An arrow that stays in the body leaves only an entry wound, which bleeds less.
- **Trails read consistently** (fourth playtest): how far off a reading is depends on the animal, not the sign, so every sign of one animal is misjudged the same way and a trail no longer seems to jump between animals of different sizes and ages. Blood shows which way it splashed, and following no longer skips drops left in the same moment. While following, every sign you've found of that animal stays clear and only other animals' signs dim; the stretch you've followed is ringed, including found signs following went past.
- **Moving targets** (fifth playtest): an animal walks on while the arrow flies (speed × flight time, the arrow at 60 m/s), so the arrow strikes behind where you aimed; the inset shows which way it moves and how far it will go. A soft bleat (`Q`) stops a roe deer for 2–4 seconds, head up and body still, but on edge; calling again only makes it warier. The aim ring is gone: only the drifting crosshair shows. The circle around the crosshair shows how ready you are: twice as wide on the draw, settling over a few seconds, tighter with a held breath, wider when you shake or your arms tire.
- **Every miss explains itself** (sixth playtest): the notice names the cause (a twig turned it, it dropped at the twang, it walked on, the crosshair was off it, or the scatter took it), and the inset stays up for a few seconds showing where the crosshair was and where the arrow passed. Hits show nothing; the blood tells. Twigs in the line are drawn across the inset with the chance they turn the arrow.
- **A shoulder-blade hit bleeds** (seventh playtest): it splashes bright red blood with bone chips where it stood, leaves a followable trail for about 100 m that thins out and dries up, and reads as "the arrow struck the shoulder blade". The deer usually lives.
